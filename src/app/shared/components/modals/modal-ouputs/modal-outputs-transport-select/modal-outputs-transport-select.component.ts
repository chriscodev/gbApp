...
@Component({
  selector: 'app-modal-outputs-transport-select',
  templateUrl: './modal-outputs-transport-select.component.html',
  styleUrls: ['./modal-outputs-transport-select.component.scss'],
})
export class ModalOutputsTransportSelectComponent implements OnInit {
